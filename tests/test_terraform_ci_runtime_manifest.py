...
VALID_MANIFEST = {
    "schema_version": 1,
    "repository": "dev-playbuilder47-eth-staking-ops/ethereum-validator-infra",
    ...
    "terraform": {
        ...
        "operator_alert_emails": [
            "dev.playbuilder47+testnet_op1@gmail.com",
            "dev.playbuilder47+testnet_op2@gmail.com",
        ],
...
class TerraformCiRuntimeManifestTests(unittest.TestCase):
    ...
    def run_helper(
        ...
        mode: str = "deploy",
        *,
        repository: str = "dev-playbuilder47-eth-staking-ops/ethereum-validator-infra",
